	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_44_0_g182 = _NoiseSpread;
				float temp_output_9_0_g185 = IN.ase_color.r;
				float2 texCoord2_g185 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_53_0_g182 = _NoiseScale;
				float simpleNoise3_g185 = SimpleNoise( texCoord2_g185*temp_output_53_0_g182 );
				float4 temp_cast_0 = (( ( temp_output_9_0_g185 + simpleNoise3_g185 ) * temp_output_9_0_g185 )).xxxx;
				float4 clampResult8_g185 = clamp( CalculateContrast(temp_output_44_0_g182,temp_cast_0) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_output_96_0_g182 = clampResult8_g185;
				float4 lerpResult62_g182 = lerp( tex2D( _RAlbedo, uv_RAlbedo ) , albedo34 , temp_output_96_0_g182);
				float temp_output_9_0_g183 = IN.ase_color.g;
				float2 texCoord2_g183 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise3_g183 = SimpleNoise( texCoord2_g183*temp_output_53_0_g182 );
				float4 temp_cast_1 = (( ( temp_output_9_0_g183 + simpleNoise3_g183 ) * temp_output_9_0_g183 )).xxxx;
				float4 clampResult8_g183 = clamp( CalculateContrast(temp_output_44_0_g182,temp_cast_1) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_output_95_0_g182 = clampResult8_g183;
				float4 lerpResult60_g182 = lerp( tex2D( _GAlbedo, uv_GAlbedo ) , lerpResult62_g182 , temp_output_95_0_g182);
				float temp_output_9_0_g184 = IN.ase_color.b;
				float2 texCoord2_g184 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise3_g184 = SimpleNoise( texCoord2_g184*temp_output_53_0_g182 );
				float4 temp_cast_2 = (( ( temp_output_9_0_g184 + simpleNoise3_g184 ) * temp_output_9_0_g184 )).xxxx;
				float4 clampResult8_g184 = clamp( CalculateContrast(temp_output_44_0_g182,temp_cast_2) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_output_94_0_g182 = clampResult8_g184;
				float4 lerpResult58_g182 = lerp( tex2D( _BAlbedo, uv_BAlbedo ) , lerpResult60_g182 , temp_output_94_0_g182);
				#ifdef _USEVERTEXCOLOURS_ON
				float4 staticSwitch236 = lerpResult58_g182;
				#else
				float4 staticSwitch236 = albedo34;
				#endif
				float4 VertColoursColour201 = staticSwitch236;
				float2 temp_cast_3 = (_GeoNoise).xx;
				float2 texCoord27_g179 = IN.ase_texcoord3.xy * temp_cast_3 + float2( 0,0 );
				float simplePerlin3D31_g179 = snoise( ( ( WorldPosition * _NoiseSize ) * float3( texCoord27_g179 ,  0.0 ) ) );
				simplePerlin3D31_g179 = simplePerlin3D31_g179*0.5 + 0.5;
				float temp_output_41_0_g179 = ( ( 1.0 - _GeoScaling ) * ( WorldPosition.y + ( simplePerlin3D31_g179 * _GeoWarp ) ) );
				float2 temp_cast_5 = (temp_output_41_0_g179).xx;
				float4 blendOpSrc37_g179 = tex2D( _GeoGradientAlbedo, temp_cast_5 );
				float4 blendOpDest37_g179 = VertColoursColour201;
				float4 lerpBlendMode37_g179 = lerp(blendOpDest37_g179,(( blendOpDest37_g179 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest37_g179 ) * ( 1.0 - blendOpSrc37_g179 ) ) : ( 2.0 * blendOpDest37_g179 * blendOpSrc37_g179 ) ),_GeoLayerOpacity);
				#ifdef _USEROCKLAYERING_ON
				float4 staticSwitch238 = ( saturate( lerpBlendMode37_g179 ));
				#else
				...
				float3 lerpResult51_g182 = lerp( unpack197 , normal25 , temp_output_96_0_g182.rgb);
				float3 lerpResult50_g182 = lerp( unpack203 , lerpResult51_g182 , temp_output_95_0_g182.rgb);
				float3 lerpResult52_g182 = lerp( unpack217 , lerpResult50_g182 , temp_output_94_0_g182.rgb);
				#ifdef _USEVERTEXCOLOURS_ON
				float3 staticSwitch237 = lerpResult52_g182;
				#else
				float3 staticSwitch237 = normal25;
				#endif
				float3 VertColoursNormal190 = staticSwitch237;
				float2 temp_cast_12 = (temp_output_41_0_g179).xx;
				float3 blendOpSrc47_g179 = UnpackNormalScale( tex2D( _GeoGradientNormal, temp_cast_12 ), 1.0f );
				float3 blendOpDest47_g179 = VertColoursNormal190;
				float3 lerpBlendMode47_g179 = lerp(blendOpDest47_g179,(( blendOpDest47_g179 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest47_g179 ) * ( 1.0 - blendOpSrc47_g179 ) ) : ( 2.0 * blendOpDest47_g179 * blendOpSrc47_g179 ) ),_GeoLayerOpacity);
				#ifdef _USEROCKLAYERING_ON
				float3 staticSwitch239 = ( saturate( lerpBlendMode47_g179 ));
				#else
				float3 staticSwitch239 = VertColoursNormal190;
				#endif
				float3 rocklayernormal235 = staticSwitch239;
				float3 temp_output_26_0_g186 = rocklayernormal235;
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 ase_worldBitangent = IN.ase_texcoord6.xyz;
				float3x3 ase_worldToTangent = float3x3(ase_worldTangent,ase_worldBitangent,ase_worldNormal);
				float3x3 ase_tangentToWorldPrecise = Inverse3x3( ase_worldToTangent );
				float3 tangentToWorldPos8_g186 = mul( ase_tangentToWorldPrecise, temp_output_26_0_g186 );
				float temp_output_9_0_g186 = ( 1.0 - _CoverageAmount );
				float clampResult21_g186 = clamp( ( ( ( ( tangentToWorldPos8_g186.y + 0.1 ) - temp_output_9_0_g186 ) * 20.0 ) + temp_output_9_0_g186 ) , 0.0 , 1.0 );
				float temp_output_9_0_g187 = clampResult21_g186;
				float2 texCoord2_g187 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise3_g187 = SimpleNoise( texCoord2_g187*_CoverageNoiseScale );
				float4 temp_cast_13 = (( ( temp_output_9_0_g187 + simpleNoise3_g187 ) * temp_output_9_0_g187 )).xxxx;
				float4 clampResult8_g187 = clamp( CalculateContrast(_CoverageSpread,temp_cast_13) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_output_55_0_g186 = clampResult8_g187;
				float3 lerpResult22_g186 = lerp( rocklayeralbedo225.rgb , tex2D( _CoverageAlbedo, texCoord185 ).rgb , temp_output_55_0_g186.rgb);
				#ifdef _USETOPCOVERAGE_ON
				float4 staticSwitch240 = float4( lerpResult22_g186 , 0.0 );
				#else
				float4 staticSwitch240 = rocklayeralbedo225;
				#endif
				float4 TopCoverAlbedo215 = staticSwitch240;
				float temp_output_14_0_g181 = saturate( ( (( WorldPosition / ( _GradientScale * 2.0 ) )).y + 0.0 ) );
				#ifdef _INVERTGRADIENT_ON
				float staticSwitch18_g181 = ( 1.0 - temp_output_14_0_g181 );
				#else
				float staticSwitch18_g181 = temp_output_14_0_g181;
				#endif
				float4 lerpResult15_g181 = lerp( _GradientTone , TopCoverAlbedo215 , staticSwitch18_g181);
				#ifdef _USEWORLDGRADIENT_ON
				float4 staticSwitch245 = lerpResult15_g181;
				#else
				...
				float3 lerpResult23_g186 = lerp( temp_output_26_0_g186 , unpack228 , temp_output_55_0_g186.rgb);
				#ifdef _USETOPCOVERAGE_ON
				float3 staticSwitch241 = lerpResult23_g186;
				#else
				...
				float3 WorldPosition5_g180 = WorldPosition;
				float3 WorldNormal5_g180 = finalnormal250;
				float3 localAdditionalLightsLambert5_g180 = AdditionalLightsLambert( WorldPosition5_g180 , WorldNormal5_g180 );
				float ase_lightAtten = 0;
				Light ase_lightAtten_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_lightAtten_mainLight.distanceAttenuation * ase_lightAtten_mainLight.shadowAttenuation;
				float4 temp_output_48_0 = ( ( _MainLightColor * _LightIntensity ) * float4( ( ( localAdditionalLightsLambert5_g180 * _AdditionalLightIntensity ) + ase_lightAtten ) , 0.0 ) );
				...
				float smoothstepResult100 = smoothstep( 1.1 , 1.12 , pow( dotResult97 , _Gloss ));
				...
				float4 rimLight58 = ( saturate( ( pow( ( 1.0 - saturate( ( _RimOffset + normalViewDir12 ) ) ) , _RimPower ) * ( normalLightDir11 * ase_lightAtten ) ) ) * ( _MainLightColor * _RimTint ) );
...
/*ASEBEGIN
Version=18900
0;73.6;2450;1152;552.912;-30.5217;1;True;False
...
Node;AmplifyShaderEditor.PowerNode;75;-2772.825,4109.45;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-3633.577,4077.863;Inherit;False;Property;_RimOffset;Rim Offset;35;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;161;-1950.629,2598.761;Inherit;False;Property;_ForceGrayscale;Force Grayscale;41;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;164;-3395.254,1190.258;Inherit;False;Property;_AdditionalLightIntensity;Additional Light Intensity;43;0;Create;True;0;0;0;False;0;False;3;4;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-3133.653,4206.896;Inherit;False;Property;_RimPower;Rim Power;37;0;Create;True;0;0;0;False;0;False;0.6361759;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;251;-198.3235,1057.883;Inherit;False;Property;_UseRimLight;Use Rim Light;50;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;271;-3749.45,6601.358;Inherit;False;Property;_FresnelPower;Fresnel Power;34;0;Create;True;0;0;0;False;0;False;1;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;270;-3564.012,6405.47;Inherit;False;Property;_EmissiveIntensity;Emissive Intensity;32;0;Create;True;0;0;0;False;0;False;1;1;1;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;203;-3263.617,-3425.092;Inherit;True;Property;_GNormal;G Normal;46;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;192;-3193.3,-5455.124;Inherit;True;Property;_CoverageAlbedo;Coverage Albedo;39;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;206;-2915.636,-2334.846;Inherit;False;WorldGradient;12;;181;e75923dfd63ec8845af54cf5ce215d1e;0;3;20;FLOAT4;0,0,0,0;False;17;FLOAT4;0,0,0,0;False;8;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;51;-3347.562,1112.406;Inherit;False;SRP Additional Light;-1;;180;6c86746ad131a0a408ca599df5f40861;3,6,1,9,1,23,0;5;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.PowerNode;98;-3034.331,4979.359;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;254;-2328.606,2997.676;Inherit;False;Property;_RampBias;Ramp Bias;40;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;131;-406.4774,922.5412;Inherit;False;124;colour;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;217;-3256.478,-3017.089;Inherit;True;Property;_BNormal;B Normal;47;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;253;-2903.815,-4513.25;Inherit;False;RockLayering;14;;179;04e7766a86dcb174389bbc903249ebfa;0;2;38;COLOR;0,0,0,0;False;48;FLOAT3;0,0,0;False;2;COLOR;0;FLOAT3;49
Node;AmplifyShaderEditor.SamplerNode;200;-3255.595,-3212.71;Inherit;True;Property;_BAlbedo;B Albedo;38;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;228;-3202.251,-5167.174;Inherit;True;Property;_CoverageNormal;Coverage Normal;48;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;256;-1803.054,3173.193;Inherit;False;Property;_RampScale;Ramp Scale;42;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;236;-2222.258,-4138.854;Inherit;False;Property;_UseVertexColours;Use Vertex Colours?;49;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;229;-3262.737,-3618.764;Inherit;True;Property;_GAlbedo;G Albedo;36;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;28;-3353.826,137.4201;Inherit;False;250;finalnormal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;166;-3107.739,1050.515;Inherit;False;Property;_LightIntensity;Light Intensity;45;0;Create;True;0;0;0;False;0;False;3;4;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;179;-4113.513,-5260.77;Inherit;False;Property;_CoverageTiling;Coverage Tiling;58;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;177;-3211.933,-2149.273;Inherit;False;Property;_GradientScale;Gradient Scale;57;0;Create;True;0;0;0;False;0;False;20;0.5;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;275;-2137.958,6505.918;Inherit;False;Property;_UseEmission3;Use Emission?;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;274;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;197;-3268.281,-3816.12;Inherit;True;Property;_RNormal;R Normal;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;223;-3261.4,-3994.797;Inherit;True;Property;_RAlbedo;R Albedo;33;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;209;-2829.348,-3856.62;Inherit;False;Property;_NoiseSpread;Noise Spread;54;0;Create;True;0;0;0;False;0;False;1;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;237;-2229.837,-4020.175;Inherit;False;Property;_UseVertexColours;Use Vertex Colours;49;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;236;True;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;243;-2843.099,-5476.998;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;173;-3170.389,-2328.727;Inherit;False;Property;_GradientTone;Gradient Tone;59;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;214;-2826.348,-3774.62;Inherit;False;Property;_NoiseScale;Noise Scale;55;0;Create;True;0;0;0;False;0;False;100;0;0;200;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;224;-2790.1,-5270.86;Inherit;False;SimpleTopCoverage;9;;186;bd8d39af5f14ca24dadd07cf86e30a0f;0;5;2;FLOAT3;0,0,0;False;25;FLOAT3;0,0,0;False;26;FLOAT3;0,0,0;False;27;FLOAT3;0,0,0;False;42;FLOAT;0;False;2;FLOAT3;0;FLOAT3;1
Node;AmplifyShaderEditor.RangedFloatNode;212;-3164.243,-4962.272;Inherit;False;Property;_CoverageAmount;Coverage Amount;56;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;183;-2693.222,-3484.15;Inherit;False;VertexColour;-1;;182;f9e293a8bd0ea15498bf4c92f8b32f08;0;10;44;FLOAT;2;False;53;FLOAT;100;False;41;COLOR;0,0,0,0;False;45;FLOAT3;0,0,0;False;42;COLOR;0,0,0,0;False;65;FLOAT3;0,0,0;False;48;COLOR;0,0,0,0;False;54;FLOAT3;0,0,0;False;47;COLOR;0,0,0,0;False;63;FLOAT3;0,0,0;False;2;COLOR;67;FLOAT3;68
Node;AmplifyShaderEditor.StaticSwitch;245;-2586.648,-2416.598;Inherit;False;Property;_UseWorldGradient;Use World Gradient?;53;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=BCB56BA5BA48D2E945D581BEF46EA379DD88CF18