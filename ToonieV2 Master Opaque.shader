	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 worldToObj50_g7 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float4 TriplanarDistanceBlend311 = _TriplanarDistanceBlend;
				float4 break313 = TriplanarDistanceBlend311;
				float clampResult7_g8 = clamp( pow( ( distance( WorldPosition , _WorldSpaceCameraPos ) / break313.z ) , break313.w ) , 0.0 , 1.0 );
				float lerpResult60_g7 = lerp( break313.x , break313.y , clampResult7_g8);
				float3 temp_output_44_0_g7 = ( ( worldToObj50_g7 / lerpResult60_g7 ) * float3(1,1,-1) );
				float2 temp_output_47_0_g7 = (temp_output_44_0_g7).yz;
				float3 worldToObjDir57_g7 = mul( GetWorldToObjectMatrix(), float4( IN.ase_normal, 0 ) ).xyz;
				float TriplanarBlend319 = _TriplanarBlend;
				float3 temp_cast_0 = (TriplanarBlend319).xxx;
				float3 temp_output_9_0_g7 = pow( abs( worldToObjDir57_g7 ) , temp_cast_0 );
				float dotResult39_g7 = dot( temp_output_9_0_g7 , float3(1,1,1) );
				float3 temp_output_15_0_g7 = ( temp_output_9_0_g7 / dotResult39_g7 );
				float2 temp_output_48_0_g7 = (temp_output_44_0_g7).xz;
				float2 temp_output_49_0_g7 = (temp_output_44_0_g7).xy;
				float4 temp_output_24_0_g7 = ( ( ( tex2D( _AlbedoX, temp_output_47_0_g7 ) * (temp_output_15_0_g7).x ) + ( tex2D( _AlbedoY, temp_output_48_0_g7 ) * (temp_output_15_0_g7).y ) ) + ( tex2D( _AlbedoZ, temp_output_49_0_g7 ) * (temp_output_15_0_g7).z ) );
				float3 temp_output_131_0_g7 = (temp_output_44_0_g7*1.0 + float3( _TriplanarNoiseOffset ,  0.0 ));
				float simpleNoise82_g7 = SimpleNoise( temp_output_131_0_g7.xy*( _TriplanarNoise.w * 100.0 ) );
				float gradientNoise94_g7 = GradientNoise(temp_output_131_0_g7.xy,_TriplanarNoise.z);
				gradientNoise94_g7 = gradientNoise94_g7*0.5 + 0.5;
				float saferPower111_g7 = max( abs( gradientNoise94_g7 ) , 0.0001 );
				float clampResult119_g7 = clamp( ( simpleNoise82_g7 / ( pow( saferPower111_g7 , _TriplanarNoise.x ) * ( 1.0 - ( _TriplanarNoise.y - 100.0 ) ) ) ) , 0.0 , 1.0 );
				float4 lerpResult71_g7 = lerp( temp_output_24_0_g7 , ( temp_output_24_0_g7 * _TriplanarNoiseTint ) , clampResult119_g7);
				#ifdef _USETRIPLANARPROJECTION_ON
				float4 staticSwitch276 = lerpResult71_g7;
				#else
				...
				float4 temp_cast_6 = (( ( temp_output_9_0_g193 + simpleNoise3_g193 ) * temp_output_9_0_g193 )).xxxx;
				float4 clampResult8_g193 = clamp( CalculateContrast(temp_output_44_0_g190,temp_cast_6) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float4 temp_cast_7 = (( ( temp_output_9_0_g191 + simpleNoise3_g191 ) * temp_output_9_0_g191 )).xxxx;
				float4 clampResult8_g191 = clamp( CalculateContrast(temp_output_44_0_g190,temp_cast_7) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float4 temp_cast_8 = (( ( temp_output_9_0_g192 + simpleNoise3_g192 ) * temp_output_9_0_g192 )).xxxx;
				float4 clampResult8_g192 = clamp( CalculateContrast(temp_output_44_0_g190,temp_cast_8) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float2 texCoord27_g187 = IN.ase_texcoord3.xy * temp_cast_9 + float2( 0,0 );
				...
				float2 temp_cast_11 = (temp_output_41_0_g187).xx;
				float4 blendOpSrc37_g187 = tex2D( _GeoGradientAlbedo, temp_cast_11 );
				...
				float3 worldToObj50_g9 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float4 break315 = TriplanarDistanceBlend311;
				float clampResult7_g10 = clamp( pow( ( distance( WorldPosition , _WorldSpaceCameraPos ) / break315.z ) , break315.w ) , 0.0 , 1.0 );
				float lerpResult60_g9 = lerp( break315.x , break315.y , clampResult7_g10);
				float3 temp_output_44_0_g9 = ( ( worldToObj50_g9 / lerpResult60_g9 ) * float3(1,1,-1) );
				float2 temp_output_47_0_g9 = (temp_output_44_0_g9).yz;
				float temp_output_151_0_g9 = normalscale231;
				float3 unpack146_g9 = UnpackNormalScale( tex2D( _NormalX, temp_output_47_0_g9 ), temp_output_151_0_g9 );
				unpack146_g9.z = lerp( 1, unpack146_g9.z, saturate(temp_output_151_0_g9) );
				float3 worldToObjDir57_g9 = mul( GetWorldToObjectMatrix(), float4( IN.ase_normal, 0 ) ).xyz;
				float3 temp_cast_15 = (TriplanarBlend319).xxx;
				float3 temp_output_9_0_g9 = pow( abs( worldToObjDir57_g9 ) , temp_cast_15 );
				float dotResult39_g9 = dot( temp_output_9_0_g9 , float3(1,1,1) );
				float3 temp_output_15_0_g9 = ( temp_output_9_0_g9 / dotResult39_g9 );
				float2 temp_output_48_0_g9 = (temp_output_44_0_g9).xz;
				float3 unpack145_g9 = UnpackNormalScale( tex2D( _NormalY, temp_output_48_0_g9 ), temp_output_151_0_g9 );
				unpack145_g9.z = lerp( 1, unpack145_g9.z, saturate(temp_output_151_0_g9) );
				float2 temp_output_49_0_g9 = (temp_output_44_0_g9).xy;
				float3 unpack144_g9 = UnpackNormalScale( tex2D( _NormalZ, temp_output_49_0_g9 ), temp_output_151_0_g9 );
				unpack144_g9.z = lerp( 1, unpack144_g9.z, saturate(temp_output_151_0_g9) );
				float3 temp_output_24_0_g9 = ( ( ( unpack146_g9 * (temp_output_15_0_g9).x ) + ( unpack145_g9 * (temp_output_15_0_g9).y ) ) + ( unpack144_g9 * (temp_output_15_0_g9).z ) );
				#ifdef _USETRIPLANARPROJECTION_ON
				float3 staticSwitch277 = temp_output_24_0_g9;
				#else
				...
				float2 temp_cast_19 = (temp_output_41_0_g187).xx;
				float3 blendOpSrc47_g187 = UnpackNormalScale( tex2D( _GeoGradientNormal, temp_cast_19 ), 1.0f );
				...
				float4 temp_cast_20 = (( ( temp_output_9_0_g195 + simpleNoise3_g195 ) * temp_output_9_0_g195 )).xxxx;
				float4 clampResult8_g195 = clamp( CalculateContrast(_CoverageSpread,temp_cast_20) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=18900
200.8;73.6;2247.6;1342.2;8531.32;-319.6397;1.180442;True;False
...
Node;AmplifyShaderEditor.FunctionNode;329;-7208.125,1344.101;Inherit;False;Triplanar;-1;;9;6f9d8679969fd99429ee2b9f9d0ffacb;6,148,1,149,1,55,1,74,0,54,1,147,1;15;1;SAMPLER2D;0,0,0;False;2;SAMPLER2D;0,0,0;False;3;SAMPLER2D;0,0,0;False;151;FLOAT;0;False;10;FLOAT;1;False;56;FLOAT;1;False;59;FLOAT;1;False;61;FLOAT;512;False;62;FLOAT;4;False;143;FLOAT4;1,1,1,0;False;138;FLOAT;5;False;137;FLOAT;40;False;141;FLOAT;10;False;139;FLOAT;1;False;140;FLOAT2;0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector4Node;300;-7514.121,292.3297;Inherit;False;Property;_TriplanarNoise;Triplanar Noise;70;0;Create;True;0;0;0;False;0;False;6,10,1,1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;328;-7091.351,-177.6631;Inherit;False;Triplanar;-1;;7;6f9d8679969fd99429ee2b9f9d0ffacb;6,148,0,149,0,55,1,74,1,54,1,147,0;15;1;SAMPLER2D;0,0,0;False;2;SAMPLER2D;0,0,0;False;3;SAMPLER2D;0,0,0;False;151;FLOAT;0;False;10;FLOAT;1;False;56;FLOAT;1;False;59;FLOAT;1;False;61;FLOAT;512;False;62;FLOAT;4;False;143;FLOAT4;1,1,1,0;False;138;FLOAT;5;False;137;FLOAT;40;False;141;FLOAT;10;False;139;FLOAT;1;False;140;FLOAT2;0,0;False;1;COLOR;0
...
WireConnection;329;1;318;0
WireConnection;329;2;316;0
WireConnection;329;3;317;0
WireConnection;329;151;307;0
WireConnection;329;10;321;0
WireConnection;329;56;315;0
WireConnection;329;59;315;1
WireConnection;329;61;315;2
WireConnection;329;62;315;3
WireConnection;277;1;23;0
WireConnection;277;0;329;0
...
WireConnection;328;1;289;0
WireConnection;328;2;290;0
WireConnection;328;3;291;0
WireConnection;328;10;320;0
WireConnection;328;56;313;0
WireConnection;328;59;313;1
WireConnection;328;61;313;2
WireConnection;328;62;313;3
WireConnection;328;143;292;0
WireConnection;328;138;300;1
WireConnection;328;137;300;2
WireConnection;328;141;300;3
WireConnection;328;139;300;4
WireConnection;328;140;298;0
...
ASEEND*/
//CHKSM=32A2ABB0A6118EE86E090F866694C33DA08B3AD1